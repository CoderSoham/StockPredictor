...
# Use historical data to train the SVR model
...
while True:
    try:
        ...
        print("Latest Timestamp:", google_latest_timestamp)
        print("Latest Price:", google_latest_price)

        # Append data to lists
        google_timestamps.append(google_latest_timestamp)
        google_prices.append(google_latest_price)

        # Predict price using the SVR model
