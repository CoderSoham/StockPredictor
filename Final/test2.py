...
def predict_and_plot_realtime_price(model, symbol):
    ...
    try:
        while True:
            ...
            if prev_real_price is not None and prev_predicted_price is not None:
                plt.clf()
                ...
                min_price = min(prev_real_price, prev_predicted_price, latest_price, predicted_price)
                max_price = max(prev_real_price, prev_predicted_price, latest_price, predicted_price)
