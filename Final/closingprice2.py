...
def main():
    ...
    # Determine whether the market will go up or down compared to today
    ...
    # Calculate the percentage change compared to today's closing price
    percentage_change = ((next_day_close - today_close) / today_close) * 100

    # Print the predicted prices, market direction, and percentage change
    ...
    print(f"Market is expected to move {market_direction} by {percentage_change:.2f}% compared to today.")
